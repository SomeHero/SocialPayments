...
set _DeploySetParametersFile=%RootPath%SocialPayments.WorkflowServices.Users.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SocialPayments.WorkflowServices.Users.zip" (
echo "%RootPath%SocialPayments.WorkflowServices.Users.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.WorkflowServices.Users.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.WorkflowServices.Users.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.WorkflowServices.Users.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%SocialPayments.WorkflowServices.Users.SetParameters.xml" %_MsDeployAdditionalFlags%
...
:usage
echo =========================================================
if not exist "%RootPath%SocialPayments.WorkflowServices.Users.deploy-readme.txt" (
...
start notepad "%RootPath%SocialPayments.WorkflowServices.Users.deploy-readme.txt"
)
echo =========================================================
goto :eof
