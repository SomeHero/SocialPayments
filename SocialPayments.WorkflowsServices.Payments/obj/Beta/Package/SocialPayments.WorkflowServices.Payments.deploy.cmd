...
set _DeploySetParametersFile=%RootPath%SocialPayments.WorkflowServices.Payments.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SocialPayments.WorkflowServices.Payments.zip" (
echo "%RootPath%SocialPayments.WorkflowServices.Payments.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.WorkflowServices.Payments.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.WorkflowServices.Payments.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.WorkflowServices.Payments.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%SocialPayments.WorkflowServices.Payments.SetParameters.xml" %_MsDeployAdditionalFlags%
...
:usage
echo =========================================================
if not exist "%RootPath%SocialPayments.WorkflowServices.Payments.deploy-readme.txt" (
...
start notepad "%RootPath%SocialPayments.WorkflowServices.Payments.deploy-readme.txt"
)
echo =========================================================
goto :eof
...
:CheckParameterFile
echo =========================================================
if  exist "%RootPath%SocialPayments.WorkflowServices.Payments.SetParameters.xml" (
echo SetParameters from:
echo "%RootPath%SocialPayments.WorkflowServices.Payments.SetParameters.xml"
echo You can change IIS Application Name, Physical path, connectionString
echo or other deploy parameters in the above file.
) else (
echo SetParamterFiles does not exist in package location.
