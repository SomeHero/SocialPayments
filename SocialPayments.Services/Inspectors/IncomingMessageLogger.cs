...
namespace SocialPayments.Services.Inspectors
{
    public class IncomingMessageLogger : IDispatchMessageInspector, IEndpointBehavior
    {
        string MessageLogFolder = System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath + @"\logs\messages\" + System.DateTime.Now.ToString("MMddyyyy") + @"\";
        ...
        {
            string messageFileName = string.Format("{0}Log{1:000}_Incoming.txt", MessageLogFolder, Interlocked.Increment(ref messageLogFileIndex), System.DateTime.Now.Date.ToString("MMddyyyy"));

            if (!Directory.Exists(MessageLogFolder))
                Directory.CreateDirectory(MessageLogFolder);
        ...
        {
            string messageFileName = string.Format("{0}Log{1:000}_Outgoing.txt", MessageLogFolder, Interlocked.Increment(ref messageLogFileIndex), System.DateTime.Now.Date.ToString("MMddyyyy"));
