...
namespace CodeFirstMembershipDemoSharp.Code
{
    public static class CodeFirstSecurity
    {
        ...
        public static string CreateAccount(string userName, string password, string email, string mobileNumber, string routingNumber, string accountNumber,
            int accountType, out MembershipCreateStatus createStatus, bool requireConfirmationToken = false)
        {
            CodeFirstExtendedProvider provider = VerifyProvider();
            return provider.CreateAccount(userName, password, email, mobileNumber, routingNumber, accountNumber, accountType, out createStatus, requireConfirmationToken);
        }
