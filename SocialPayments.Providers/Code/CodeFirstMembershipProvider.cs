    ...
    public class CodeFirstMembershipProvider : CodeFirstExtendedProvider
            ...
            int accountType, out MembershipCreateStatus createStatus, bool requireConfirmationToken)
                ...
                public override bool ConfirmAccount(string accountConfirmationToken)
                {
                    ...
                    using (Context context = new Context())
                    {
                        dynamic row = context.Users.FirstOrDefault(Usr => Usr.ConfirmationToken.Equals(accountConfirmationToken));
                        if (row != null)
                        {
                ...
                public override string ExtendedValidateUser(string userNameOrEmail, string password)
                {
                    ...
                    using (Context context = new Context())
                    {
                        ...
                        if (user == null)
                        {
                            user = context.Users.FirstOrDefault(Usr => Usr.EmailAddress == userNameOrEmail);
                        }
                        if (user == null)
                        {
                            return string.Empty;
                ...
                public override System.Web.Security.MembershipUser GetUser(string userName, bool userIsOnline)
                {
                    ...
                    using (Context context = new Context())
                    {
                        ...
                        return new MembershipUser(Membership.Provider.Name, userName, user.UserId, user.EmailAddress, null, null, true, false, user.CreateDate, DateTime.MinValue,
