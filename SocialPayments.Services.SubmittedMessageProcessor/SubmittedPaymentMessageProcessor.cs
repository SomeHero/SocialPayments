        ...
        public bool Process(Message message)
        {
            ...
            if (recipientType == URIType.FacebookAccount)
            {
                try
                {
                    ...
                    args["message"] = String.Format("I sent you ${0} using PaidThx. Why, you ask? {1} Click on this link to pick it up! {2}", message.Amount, formattedComments, message.shortUrl);
                    args["link"] = message.shortUrl;

                    args["name"] = "You were sent money!";
                    args["caption"] = "The FREE Social Payment Network";
                    args["picture"] = "http://www.crunchbase.com/assets/images/resized/0019/7057/197057v2-max-250x250.png"; // Hard coded twitter page avatar
                    args["description"] = "PaidThx lets you send and receive money whenever you want, wherever you want. It is easy to do, and doesn't cost you a penny.";
                    // Link title is currently auto-generated by the <HEAD> title of the shortURL website.
