...
namespace SocialPayments.Services.MessageProcessors.UnitTest
{
    ...
    /// </summary>
    [TestClass]
    public class SubmittedPaymentMessageProcessorTest
    {
        private IDbContext _ctx;
        private IEmailService _emailService;
        private ISMSService _smsService;

        public SubmittedPaymentMessageProcessorTest()
        {
             _ctx = new FakeDbContext();
             _emailService = new FakeEmailService();
            _smsService = new FakeSMSService();
        }
        public SubmittedPaymentMessageProcessorTest(IDbContext context, IEmailService emailService, ISMSService smsService)
        {
            _ctx = context;
        ...
        public void WhenPendingPaymentMessageWithMobileNumberRecipientUriProcessedWithUnknownRecipientOneTransactionIsCreated()
        {
            ...
            SubmittedPaymentMessageProcessor processor = new SubmittedPaymentMessageProcessor(_ctx, _emailService, _smsService);
