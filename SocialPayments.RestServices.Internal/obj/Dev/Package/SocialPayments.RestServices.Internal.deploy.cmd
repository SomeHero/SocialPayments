...
set _DeploySetParametersFile=%RootPath%SocialPayments.RestServices.Internal.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SocialPayments.RestServices.Internal.zip" (
echo "%RootPath%SocialPayments.RestServices.Internal.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.RestServices.Internal.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.RestServices.Internal.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SocialPayments.RestServices.Internal.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%SocialPayments.RestServices.Internal.SetParameters.xml" %_MsDeployAdditionalFlags%
...
:usage
echo =========================================================
if not exist "%RootPath%SocialPayments.RestServices.Internal.deploy-readme.txt" (
...
start notepad "%RootPath%SocialPayments.RestServices.Internal.deploy-readme.txt"
)
echo =========================================================
goto :eof
